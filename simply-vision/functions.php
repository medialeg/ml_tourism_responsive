...
function modernwpthemes_print_customstyles() {
    ...
    modernwpthemes_print_background('custom_background', 'body');
...
function modernwpthemes_print_background( $option, $selector ) {
	...
	if  (of_get_option('custom_css') != ''){
		add_action('wp_head', 'modernwpthemes_general_opt');
		function modernwpthemes_general_opt(){
			$output = "\n<style type='text/css'>";
	...
	if  (of_get_option('custom_js') != ''){
		add_action('wp_footer', 'modernwpthemes_general_opt');
		function modernwpthemes_general_opt(){
